...
A short installation guide for a Slurm cluster running each component on a different node with an additional backup controller and a database daemon.
...
Slurm Primary Database Daemon |lxcc01                       |lxcc01.devops.test
Slurm Backup Database Daemon  |lxcc02                       |lxcc02.devops.test
...
CREATE USER 'slurm'@'lxcc02.devops.test' IDENTIFIED BY '12345678';
```
...
GRANT ALL ON slurm_acct_db.* TO 'slurm'@'lxcc02.devops.test';
```
